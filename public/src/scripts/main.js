...
var ExxWebSocket = {
    ...
    ExxWebSocket.dealMessageHandle = function (data, type) {
        if (type == 1) {
            ...
            var result = {"asks":[[0.002009,1.00],[0.004313,0]],"currentPrice":0.001949,"bids":[[0.000194,6.80],[0.000970,5.20],[0.001264,0.80],[0.001267,6.00],[0.001276,3.20],[0.001425,11.40],[0.001715,14.00],[0.001725,0.70],[0.001868,15.30],[0.001880,15.60]],"channel":"qtumbtc_cny_depth"};
