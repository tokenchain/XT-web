...
//jquery分页插件
	    ...
	    var ms = {
	        ...
	        NPfillHtml: function(obj, args) {
	            return (function() {
	                ...
	                //上一页
	                if (args.current > 1) {
	                    obj.append('<li class="prevPage"><a href="javascript:;">上一页</a></li>');
	                } else {
	                    obj.remove('.prevPage');
	                    obj.append('<li class="disabled"><a href="javascript:;">上一页</a></li>');
	                }
	                //下一页
	                if (args.rsCount < args.pageSize) {
	                    obj.remove('.nextPage');
	                    obj.append('<li class="disabled"><a href="javascript:;">下一页</a></li>');
	                } else {
	                	obj.append('<li class="nextPage"><a href="javascript:;">下一页</a></li>');
	                }
	...
	$(function(){
		$(".fill-dizhi-con li input").on("focus", function(){
			$(this).parent("li").addClass("active");
		});
		$(".fill-dizhi-con li input").on("blur", function(){
