...
EXX.pack = {
    ...
    '6057': {cn: '修改角色失败', en: 'Failed to modify role', jp: '', kr: ''},
    '6058': {cn: '删除角色失败', en: 'Failed to delete the role', jp: '', kr: ''},
    '6061':
        {
    ...
    '6120': {cn: '取消提现', en: 'Cancel the withdrawal!', jp: '', kr: ''},
    '6121': {cn: '未找到记录！', en: 'Record was not found!', jp: '', kr: ''},
    '6122':
        {
            cn: '此条提现申请已经被取消或禁用！',
    ...
    '6124': {cn: '审核失败！', en: 'Audit failure!', jp: '', kr: ''},
    '6125':
        {
            cn: '无效的货币类型！',
    ...
    '6126': {cn: '审核通过', en: 'Audit Approve!', jp: '', kr: ''},
    '6127':
        {
            cn: '验证码发送成功，10分钟内有效!',
            en: 'Verification code sent successfully, valid for 10 minutes!',
    ...
    '6129': {cn: '审核不通过！', en: 'Audit not through!', jp: '', kr: ''},
    '6130':
        {
            cn: '没有选取币种！',
    ...
    '6131': {cn: '应用不存在！', en: 'APP is not exist!', jp: '', kr: ''},
    '6132':
        {
            cn: '今天已经发送超过次，请明天再重试！',
...
EXX.toFT = function (cc) {
    var str = '', ss = EXX.JTPYStr, tt = EXX.FTPYStr;
