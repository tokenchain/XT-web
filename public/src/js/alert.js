...
// github.com/t4t5/sweetalert
            ...
            /*
             *  Handle newAlert's DOM elements
             */

            var _newAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition = require('./modules/handle-Alert-dom');
...
// Default values
            ...
            /*
             * Global newAlert function
             * (this is what the user calls)
             */
            var newAlert, Alert;

            exports['default'] = newAlert = Alert = function () {
                var customizations = arguments[0];

                _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide$isDescendant$getTopMargin$fadeIn$fadeOut$fireClick$stopEventPropagation.addClass(document.body, 'stop-scrolling');
                _newAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.resetInput();
                ...
                switch (typeof customizations) {
                    ...
                    // Ex: Alert("Hello", "Just testing", "info");
                    case 'string':
                    ...
                    // Ex: Alert({ title:"Hello", text: "Just testing", type: "info" });
                    case 'object':
                ...
                _newAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.fixVerticalPosition();
                _newAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.openModal(arguments[1]);

                // Modal interactions
                var modal = _newAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
                ...
                _newAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getOverlay().onclick = onButtonEvent;
             ...
             */
            newAlert.setDefaults = Alert.setDefaults = function (userParams) {
                if (!userParams) {
             ...
             */
            newAlert.close = Alert.close = function () {
                var modal = _newAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();

                _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide$isDescendant$getTopMargin$fadeIn$fadeOut$fireClick$stopEventPropagation.fadeOut(_newAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getOverlay(), 5);
             ...
             */
            newAlert.showInputError = Alert.showInputError = function (errorMessage) {
                var modal = _newAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
             ...
             */
            newAlert.resetInputError = Alert.resetInputError = function (event) {
             ...
             */
            newAlert.disableButtons = Alert.disableButtons = function (event) {
                var modal = _newAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
             ...
             */
            newAlert.enableButtons = Alert.enableButtons = function (event) {
                var modal = _newAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
                var $confirmButton = modal.querySelector('button.confirm');
                var $cancelButton = modal.querySelector('button.cancel');
            ...
            if (typeof window !== 'undefined') {
                ...
                // that 'newAlert' was set as global.
                window.newAlert = window.Alert = newAlert;
            } else {
                _extend$hexToRgb$isIE8$logStr$colorLuminance.logStr('SweetAlert is a frontend module!');
            }
            module.exports = exports['default'];

        },{"./modules/default-params":2,"./modules/handle-click":3,"./modules/handle-dom":4,"./modules/handle-key":5,"./modules/handle-Alert-dom":6,"./modules/set-params":8,"./modules/utils":9}],2:[function(require,module,exports){
            'use strict';
            ...
            var _getModal = require('./handle-Alert-dom');
        ...
        },{"./handle-dom":4,"./handle-Alert-dom":6,"./utils":9}],4:[function(require,module,exports){
            'use strict';
            ...
            var _setFocusStyle = require('./handle-Alert-dom');
        ...
        },{"./handle-dom":4,"./handle-Alert-dom":6}],6:[function(require,module,exports){
            'use strict';
            ...
            var newAlertInitialize = function newAlertInitialize() {
            ...
            exports.newAlertInitialize = newAlertInitialize;
...
// Dark overlay
            ...
            var _getModal$getInput$setFocusStyle = require('./handle-Alert-dom');
                    ...
                    var _ret = (function () {
                        ...
                        switch (params.type) {
                            ...
                            case 'prompt':
                                ...
                                setTimeout(function () {
                                    $input.focus();
                                    $input.addEventListener('keyup', Alert.resetInputError);
                                }, 400);
                                break;
                        }
                    })();
        ...
        },{"./handle-dom":4,"./handle-Alert-dom":6,"./utils":9}],9:[function(require,module,exports){
            'use strict';
