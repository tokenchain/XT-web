...
LightTheme.prototype.__construct = function() {
    ...
    if(isLight){
        ...
        this._colors[Theme.Color.Indicator1] = "rgba(195,154,119,1)";  //第二条颜色
        this._colors[Theme.Color.Indicator2] = "rgba(81,159,187,.7)"; //第三条颜色
        ...
        this._colors[Theme.Color.Text0] = "#2B2929";
        this._colors[Theme.Color.Text1] = "#666";
        this._colors[Theme.Color.Text2] = "rgba(255,255,255,.3)";//坐标轴数字颜色
